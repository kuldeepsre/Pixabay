import 'models/side_menu_one_model.dart';
import 'package:flutter/material.dart';
import 'package:kuldeep_s_application10/core/app_export.dart';
import 'bloc/side_menu_one_bloc.dart';

class SideMenuOneScreen extends StatelessWidget {
  const SideMenuOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<SideMenuOneBloc>(
      create: (context) => SideMenuOneBloc(SideMenuOneState(
        sideMenuOneModelObj: SideMenuOneModel(),
      ))
        ..add(SideMenuOneInitialEvent()),
      child: SideMenuOneScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SideMenuOneBloc, SideMenuOneState>(
