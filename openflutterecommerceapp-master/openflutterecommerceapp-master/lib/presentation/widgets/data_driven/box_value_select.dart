  ...
  Container buildBoxWidget(T currentValue, BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: widget.selectedValues.contains(currentValue) ? _theme.splashColor : _theme.primaryColorLight),
          color: widget.selectedValues.contains(currentValue) ? _theme.splashColor : AppColors.white),
      ...
      child: Text(
        ...
        style: _theme.textTheme.headline2?.copyWith(
          color: widget.selectedValues.contains(currentValue) ? AppColors.white : _theme.splashColor,
        ),
      ),
    );
  }
