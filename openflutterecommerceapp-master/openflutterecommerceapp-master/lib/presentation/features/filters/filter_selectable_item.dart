    ...
    return Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: isSelected ? Theme.of(context).splashColor : Theme.of(context).primaryColorLight),
              color: isSelected ? Theme.of(context).splashColor : AppColors.white),
